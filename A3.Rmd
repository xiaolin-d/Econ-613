...
coef4[1,1]
```
The estimated $\beta$ is `r coef4[1,1]`. Here taking the mean does not eliminate individual fixed effects, but since there are 10k+ individuals, the calculation amount is too large if I estimate the individual fixed effects for each individual.
