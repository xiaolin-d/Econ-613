...
{
  start = runif(4,-10,10)
  probit_res = optim(start,fn=probit_flike,method="BFGS",control=list(trace=0,maxit=1000),x1=x1,x2=x2,x3=x3,ydum=ydum)
  out[i0,] = probit_res$par
}
start = runif(4)
probit_res = optim(start,fn=probit_flike,method="BFGS",control=list(trace=0,maxit=1000),x1=x1,x2=x2,x3=x3,ydum=ydum,hessian=TRUE)
...
{
  start = runif(4,-10,10)
  logit_res = optim(start,fn=logit_flike,method="BFGS",control=list(trace=0,maxit=1000),x1=x1,x2=x2,x3=x3,ydum=ydum)
  out[i0,] = logit_res$par
}
start = runif(4)
logit_res = optim(start,fn=logit_flike,method="BFGS",control=list(trace=0,maxit=1000),x1=x1,x2=x2,x3=x3,ydum=ydum,hessian=TRUE)
